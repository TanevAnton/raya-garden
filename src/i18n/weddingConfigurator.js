...
const bg = {
  ...
  date: {
    ...
    timeLabel: "Приблизителен начален час (по избор)",
  ...
  included: {
    title: "Какво включва пакетът",
    toggleOpen: "Виж всичко включено",
    toggleClose: "Скрий",
    note: "Тези услуги са включени в пакетната цена на човек.",
  },
  ...
  menus: {
    ...
    mixedToggle: "Желаем различни варианти за различни гости",
    mixedHint:
      "Разпределението е Ваше желание и подлежи на потвърждение от хотела — офертата не описва смесени менюта.",
    mixedSumLabel: "Разпределени",
    mixedSumError: "Сборът трябва да е равен на броя гости със стандартно меню ({n}).",
  ...
  contact: {
    ...
    email: "Имейл",
    address: "Адрес",
    addressHint: "Пощенски адрес за кореспонденция.",
...
const en = {
  ...
  date: {
    ...
    timeLabel: "Approximate start time (optional)",
  ...
  included: {
    ...
    toggleOpen: "See everything included",
    toggleClose: "Hide",
    note: "These services are included in the per-person package price.",
  },
  ...
  menus: {
    ...
    mixedToggle: "We'd like different variants for different guests",
    mixedHint:
      "The split is your request and subject to confirmation — the offer doesn't describe mixed menus.",
    mixedSumLabel: "Allocated",
    mixedSumError: "The total must equal the number of standard-menu guests ({n}).",
  ...
  contact: {
    ...
    email: "Email",
    address: "Address",
    addressHint: "Postal address for correspondence.",
...
const ro = {
  ...
  date: {
    ...
    timeLabel: "Ora aproximativă de început (opțional)",
  ...
  included: {
    ...
    toggleOpen: "Vezi tot ce este inclus",
    toggleClose: "Ascunde",
    note: "Aceste servicii sunt incluse în prețul de pachet pe persoană.",
  },
  ...
  menus: {
    ...
    mixedToggle: "Dorim variante diferite pentru invitați diferiți",
    mixedHint:
      "Repartizarea este dorința dumneavoastră și se confirmă de hotel — oferta nu descrie meniuri mixte.",
    mixedSumLabel: "Repartizate",
    mixedSumError: "Suma trebuie să fie egală cu numărul invitaților cu meniu standard ({n}).",
  ...
  contact: {
    ...
    email: "E-mail",
    address: "Adresă",
    addressHint: "Adresă poștală pentru corespondență.",
